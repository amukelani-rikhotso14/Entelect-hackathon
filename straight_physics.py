...
def simulate_straight(entry_v, target_v, corner_entry_v, length, accel_rate, brake_rate):
    """
...
def is_straight_feasible(entry_v, target_v, corner_entry_v, length, accel_rate, brake_rate):
    """
